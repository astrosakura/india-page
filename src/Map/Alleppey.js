...
const Alleppey = () => {
    ...
    const circlePosition = [19.8762, 75.6493];
    ...
    return (
        ...
        <h5 className = "home-icon" onClick={() => setIsAuth(false)}><HomeIcon fontSize = "large"/><br/>Home</h5><br/>
       ...
       <div class="container">
        ...
        <div className = "row">
            <MapContainer
             ...
             <Marker  position = {[9.4981, 76.3388]} icon = {markerIcon}>
                <Popup><b>Alappuzha, Kerala</b></Popup>
             </Marker>
