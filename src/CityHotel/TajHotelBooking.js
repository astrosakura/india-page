...
import img1 from "../Images/agra-hotel1.jpg";
import img2 from "../Images/agra-hotel2.jpg";
    ...
    return (
       <>
        ...
        <div className = "text-wrap-image">
             Agra, India <br/>
            <h2 style = {{marginRight: '5%', marginBottom: '-1%'}}>Hotel Taj Resorts</h2><br/>
            <p><RoomIcon style = {{marginLeft: '9%', color: 'grey'}}/> Taj Mahal • 1.2 km away</p>
        ...
        <div className = "text-wrap-image">
            Agra, India <br/>
            <h2 style = {{marginRight: '5%', marginBottom: '-1%'}}>The Oberoi Amarbilas, Agra</h2><br/>
            <p><RoomIcon style = {{marginLeft: '9%', color: 'grey'}}/>Taj Mahal • 1.2 km away</p>
            <p style = {{marginBottom: '-5%'}}>
             <span><StarIcon style = {{color: 'orange', marginLeft :'10%'}}/></span>
             <span><StarIcon style = {{color: 'orange'}}/></span>
...
export default TajHotelBooking
